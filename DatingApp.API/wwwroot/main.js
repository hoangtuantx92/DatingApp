...
var MemberEditResolver = /** @class */ (function () {
    ...
    MemberEditResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberEditResolver);
...
/*!****************************************************!*\
  !*** ./src/app/_resolvers/member-list.resolver.ts ***!
  \****************************************************/
/*! exports provided: MemberListlResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MemberListlResolver", function() { return MemberListlResolver; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/user.service */ "./src/app/_services/user.service.ts");
/* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
...
var MemberListlResolver = /** @class */ (function () {
    function MemberListlResolver(userService, router, alertify) {
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
        this.pageNumber = 1;
    ...
    MemberListlResolver.prototype.resolve = function (route) {
        var _this = this;
    ...
    MemberListlResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberListlResolver);
    return MemberListlResolver;
}());
...
/* harmony import */ var _member_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./member/member-list/member-list.component */ "./src/app/member/member-list/member-list.component.ts");
...
/* harmony import */ var _member_member_card_member_card_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./member/member-card/member-card.component */ "./src/app/member/member-card/member-card.component.ts");
/* harmony import */ var _member_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./member/member-detail/member-detail.component */ "./src/app/member/member-detail/member-detail.component.ts");
...
/* harmony import */ var _member_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./member/member-edit/member-edit.component */ "./src/app/member/member-edit/member-edit.component.ts");
...
/* harmony import */ var _member_photo_editor_photo_editor_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./member/photo-editor/photo-editor.component */ "./src/app/member/photo-editor/photo-editor.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _member_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_17__["MemberListComponent"],
                ...
                _member_member_card_member_card_component__WEBPACK_IMPORTED_MODULE_23__["MemberCardComponent"],
                _member_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_24__["MemberDetailComponent"],
                _member_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_27__["MemberEditComponent"],
                _member_photo_editor_photo_editor_component__WEBPACK_IMPORTED_MODULE_30__["PhotoEditorComponent"],
            ...
            providers: [
                ...
                _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_26__["MemberListlResolver"],
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (data) {
            _this.alertify.success('You have liked: ' + _this.user.knowAs);
        }, function (error) {
            _this.alertify.error(error);
        });
    };
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this photo?', function () {
            _this.userService.deletePhoto(_this.authService.decodedToken.nameid, id).subscribe(function () {
                ...
                _this.alertify.error('Falied to delete the photo');
            });
        });
    };
    __decorate([
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.createRegisterForm = function () {
        this.registerForm = this.fb.group({
            ...
            knowAs: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
...
var appRoutes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            { path: 'members', component: _member_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_1__["MemberListComponent"],
                resolve: { users: _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_7__["MemberListlResolver"] } },
            { path: 'members/:id', component: _member_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_5__["MemberDetailComponent"],
                resolve: { user: _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_6__["MemberDetailResolver"] } },
            { path: 'member/edit', component: _member_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_8__["MemberEditComponent"],
...
module.exports = __webpack_require__(/*! /Users/kevindo/DatingApp/DatingApp-SPA/src/main.ts */"./src/main.ts");
